...
class Game():
    ...
    def check_collisions(self):
        ...
        #Check for collisions between player and individual monster
        #We must test the type of monster to see if it matches our target monster
    ...
    def pause_game(self, main_text, sub_text):
        ...
        main_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2 - 32)
